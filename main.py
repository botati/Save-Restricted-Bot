...
-  **هذا البـوت مسـاعد للبـوت الرئيسي ولكن هذا النسخه بها ميزات جبارة كمـا تم توضيحها سـابقـا** 🆕✅

- لـبدأ سحـب منـشور ارسـل رابــط وسأقوم بسحبه لـك مـن مجموعات أو topic الـخاصـة او العـامة حتي القنوات المقيدة او الخـاصه بسهوله 🔥🆕

**يـمـكـنك تشغيل السـحب الـمتعدد** 🔥🚀
/get

**ملاحظة هامة:** ‼️
- يجب أن يكون الحساب المساعد عضواً في القناة او المجموعه الخاصة لتتمكن من سحب المحتوى منها.

- قريـبـا سيـكون هنـاك تحديثات جبارة و قويه انتظرو ⤴️🔥
